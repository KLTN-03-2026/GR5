      ...
      <section className="px-6 mb-16">
        <div className="max-w-7xl mx-auto relative h-[600px] rounded-[2.5rem] overflow-hidden group">
          ...
          <div className="relative h-full flex flex-col justify-center px-12 md:px-24 max-w-3xl">
            ...
            >
              Kết nối trực tiếp từ những cánh đồng xanh ngát tới bàn ăn gia đình
              bạn. Chất lượng thượng hạng, minh bạch nguồn gốc.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <div className="col-span-12 lg:col-span-8 bg-emerald-50/50 rounded-[2.5rem] p-10 relative overflow-hidden flex flex-col justify-between min-h-[500px] border border-emerald-100">
            ...
            <div className="relative z-10 max-w-xs">
              ...
              <p className="text-gray-600 font-body mb-8">
                Chúng tôi tin rằng thực phẩm ngon nhất bắt đầu từ một nền đất
                khỏe mạnh. Tìm hiểu cách các đối tác nông dân của chúng tôi đang
                bảo vệ hệ sinh thái.
              </p>
          ...
          <div className="col-span-12 lg:col-span-4 flex flex-col gap-6">
            <div className="flex-1 bg-emerald-700 rounded-[2.5rem] p-8 text-white flex flex-col justify-between overflow-hidden relative group">
              <div className="relative z-10">
                ...
                <p className="text-emerald-100 text-sm mb-8 leading-relaxed">
                  Tiết kiệm 15% khi đăng ký gói giao hàng định kỳ mỗi thứ 3 hàng
                  tuần.
                </p>
              </div>
            ...
            <div className="flex-1 bg-orange-50 rounded-[2.5rem] p-8 flex flex-col justify-between relative group border border-orange-100">
              <div>
                ...
                <h3 className="text-2xl font-headline font-bold mb-2 text-gray-900">
                  Trái Cây Nhập Khẩu
                </h3>
                <p className="text-gray-600 text-sm font-medium">
                  Cherry New Zealand & Táo Envy đang có giá tốt nhất mùa.
                </p>
              </div>
              <div className="flex items-end justify-between mt-8">
                <div>
                  <p className="text-xs line-through text-gray-400">550.000đ</p>
                  <p className="text-2xl font-headline font-extrabold text-orange-600">
                    399.000đ
                  </p>
                </div>
        ...
        <div className="flex justify-between items-end mb-12">
          <div>
            ...
            <p className="text-gray-500 mt-2">
              Những sản phẩm vừa thu hoạch sáng nay
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {PRODUCTS.map((product) => (
            <motion.div
              key={product.id}
              whileHover={{ y: -8 }}
              className="bg-white p-4 rounded-[1.5rem] group hover:shadow-2xl hover:shadow-emerald-900/5 transition-all duration-300 border border-gray-100"
            >
              ...
              <div className="px-2">
                ...
                <h4 className="font-headline font-bold text-gray-900 mb-2 line-clamp-1">
                  {product.name}
                </h4>
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto bg-[#EFF6EA] rounded-[3rem] p-12 text-center border border-emerald-100 relative overflow-hidden">
          <div className="relative z-10">
            ...
            <h2 className="text-3xl font-headline font-extrabold text-gray-900 mb-4">
              Nhận bản tin nông vụ hàng tuần
            </h2>
            <p className="text-gray-600 font-body mb-10 max-w-xl mx-auto">
              Cập nhật những nông sản mới nhất vào mùa, ưu đãi độc quyền dành
              riêng cho thành viên và các kiến thức sống xanh.
            </p>
            ...
            >
              <input
                ...
                className="flex-1 bg-white border border-emerald-100 rounded-xl px-6 py-4 outline-none focus:ring-2 focus:ring-emerald-500 shadow-sm"
              />
            ...
            <p className="mt-6 text-xs text-gray-400 italic">
              Chúng tôi cam kết bảo mật thông tin của bạn. Không bao giờ spam.
            </p>
          </div>
        </div>
      </section>
