...
export default async function ProductsPage({
  ...
  // Tham số lọc Sao đánh giá (Lọc các SP có sao >= rating)
  const minRating = params?.rating ? Number(params.rating) : undefined;

  // 1. ĐIỀU KIỆN LỌC DATABASE (Tên, Danh Mục, Giá)
  ...
  // 4. LỌC THEO SAO ĐÁNH GIÁ (Thực hiện sau khi đã tính trung bình sao)
  if (minRating) {
